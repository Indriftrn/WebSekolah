...
@section('title','Mapel')
@section('content')
<h1 class="h2 border-bottom pt-3 pb-3">Mapel</h1>
...
<div class="row">
	<div class="col-md-6 mb-3">
		...
		href="{{ route('course.create') }}">[+] Buat Baru</a>
	</div>
</div>
	...
	@foreach($data as $row)
		<tr>
			...
			<td>
				...
				href="{{ route('course.edit',['course'=>$row->id]) }}">
					<i class="fas fa-edit"></i>
				</a>
				<button class="btn btn-sm btn-danger tombol-hapus" 
				type="button" 
				data-url="{{ route('course.destroy',['course'=>$row->id]) }}">
