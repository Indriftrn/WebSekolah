...
<section id="sambutan">
    <div class="container">
      <h5>PROFIL SMP NEGERI 2 PAMARICAN</h5>
      <div class="row">
        <div class="col-md-6">
          <div class="foto-wrapper">
            <img src="{{ ('/img/kepsek.png') }}">
          </div>
        </div>
        <div class="col-md-6">
          <h5>Sambutan Kepala Sekolah</h5>
          <p>Assalamualaikum.Wr.Wb<br>
            Puji syukur kita panjatkan kehadirat Allah SWT atas rahmat, hidayah, dan karunia-Nya serta segala kebaikan yg telah diberikan sehingga SMPN 2 Pamarican dapat mengaktifkan kembali website sekolah www.smpn2pamarican.sch.id. 
            Keberadaan website sekolah dewasa ini dipandang sangat penting sebagai media publikasi sekolah. 
            Selain itu, website sekolah ini bisa dimanfaatkan sebagai...</p>
