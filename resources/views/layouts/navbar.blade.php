    ...
    <div class="row">
      <div class="col-md-8">
        <ul class="top-contact">
          <li><a href=""><i class="fas fa-phone"></i>(0265) 650406</a></li>
          <li><a href=""><i class="fas fa-envelope"></i>smpdupan@gmail.com</a></li>
        </ul>
      </div>
      <div class="col-md-4">
        <ul class="sosmed">
      ...
      <div class="col-md-8">
        <div class="brand">
          ...
          <div class="brand-name">
            <h1>SMP Negeri 2 Pamarican</h1>
            <h3>Sekolah Pencetak Generasi Teladan dan Berprestasi</h3>
          </div>
        </div>
      </div>
        ...
        <div class="searchbox">
          <form method="get">
            <div class="input-group">
              <input class="form-control" type="text" name="cari" placeholder="Cari Sesuatu.." aria-label="Tombol Cari"
                aria-describedy="tombol-cari">
      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu">
            ...
            <a class="dropdown-item" href="#">Peta Sekolah</a>
          </div>
        </li>
        <li class="nav-item dropdown">
          <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
            role="button">Sarana & Prasarana</a>
          <div class="dropdown-menu">
            <a class="dropdown-item" href="#">Sarana Infrastruktur</a>
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu">
            ...
            <a class="dropdown-item" href="#">Galeri Video / Dokumentasi</a>
          </div>
        </li>
        <li class="nav-item">
